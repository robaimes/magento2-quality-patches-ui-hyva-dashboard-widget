...
* `composer require aimes/magento2-quality-patches-ui-hyva-dashboard-widget`
* `bin/magento module:enable Aimes_QualityPatchesUiHyvaDashboardWidget`
* `bin/magento setup:upgrade`

## Usage
- Click 'Add Widget' in the Hyvä Dashboard
- Select 'Quality Patches'
...
[release-badge]:https://img.shields.io/github/v/release/robaimes/magento2-quality-patches-ui-hyva-dashboard-widget?&style=for-the-badge
[packagist]:https://packagist.org/packages/aimes/magento2-quality-patches-ui-hyva-dashboard-widget
[gpl]:https://www.gnu.org/licenses/gpl-3.0.en.html
[author]:https://aimes.dev/
[hyva-dashboard]:https://docs.hyva.io/hyva-commerce/features/admin-dashboard/index.html
[qualitypatchesui]:https://github.com/robaimes/module-quality-patches-ui
